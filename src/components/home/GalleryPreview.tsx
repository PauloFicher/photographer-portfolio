  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto relative z-10">
        <AnimatedSection animation="fadeUp" delay={100} className="text-center mb-8 md:mb-10">
          ...
          {categories.map((category, idx) => (
            ...
            >
              <Link
                ...
                className="relative overflow-hidden group cursor-pointer rounded-xl md:rounded-2xl block h-full"
              >
        ...
        <AnimatedSection animation="fadeUp" delay={1000} className="text-center">
          <Link 
            to="/galeria"
